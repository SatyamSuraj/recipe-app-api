...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        new_tag = sample_tag(user=self.user, name='Tag_update')
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """Test returnning recipes with specific tag"""
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Recipe1')
        recipe2 = sample_recipe(user=self.user, title='Recipe2')
        ing1 = sample_ingredient(user=self.user, name='ing1')
        ing2 = sample_ingredient(user=self.user, name='ing2')
